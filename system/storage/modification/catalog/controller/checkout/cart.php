...
class ControllerCheckoutCart extends Controller {
	public function index() {
		...
		//if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
            ...
            $data['contacts_data'] = $this->language->get('contacts_data');
            $data['contacts_string'] = $this->language->get('contacts_string');
        ...
        if (isset($data['account_custom_field'][1]) && !empty($data['account_custom_field'])) {
            $data['image'] = $this->model_account_custom_field->getCustomFieldImage($data['account_custom_field'][1]);
        }
