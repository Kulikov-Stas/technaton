        ...
        <div class="row">
            <div class="footer-wrapper">
                <div class="footer-logo">
                    <a href="/">
                        <img src="catalog/view/theme/technaton/img/techno_log.png" alt="">
                    </a>
                </div>
                <div class="footer-menu-list">
                    <ul class="firstMenu">
                        <li class="active"><a href="/"><?php echo $text_home; ?></a></li>
                        <li><a href="/shop/"<?php echo $text_catalog; ?></a></li>
                        <li><a href="/manual/"><?php echo $text_manual; ?></a></li>
                        <li><a href="/about_us/"><?php echo $text_about; ?></a></li>
                        <li><a href="/news/"><?php echo $text_news; ?></a></li>
                    ...
                    <ul class="secondMenu">
                        <li><a href="/spare-parts/"><?php echo $text_spare_parts; ?></a></li>
                        <li><a href="/instruments/"><?php echo $text_instruments; ?></a></li>
                        <li><a href="/consumables/"><?php echo $text_consumables; ?></a></li>
                        <li><a href="/additionally/"><?php echo $text_additionally; ?></a></li>
                    </ul>
                </div>
                <p class="rightReserved">© 2009–<?php echo date('Y'); ?> <?php echo $powered; ?></p>
            </div>
        </div>
    </div>
</footer>
                ...
                <div class="popup-content">
                    <div class="success-wrapper">
                        ...
                        <div class="success-discription">
                            <h3 class="colorHeading H3 success-title">Ваш заказ<span class="H3 " style="color: #007DC4;"> успешно оформлен</h3>
                            <p class="success-text">На электронную почту профиля мы выслали данные о заказе</p>
                            </div>
                        </div>
                </div>
            </div>
                ...
                <div class="popup-content">
                    <div class="success-wrapper">
                        ...
                        <div class="success-discription">
                            ...
                            <p class="success-text">Теперь вы можете входить на Технатон.</p>
                            <p class="success-text">На электронную почту профиля мы выслали пароль
                                вашей учетной записи на Технатон</p>
                        </div>
                    </div>
                </div>
            </div>
...
<div id="login_popup" class="white-popup mfp-hide">
    <div class="popup-wrapper">
        <div class="popup-block">
            <div class="lose-password">
                <div class="shopping-btn profile-ajax">
                    <svg xmlns="http://www.w3.org/2000/svg" width="63.229" height="49" viewBox="0 0 63.229 49">
                        <rect id="Rectangle_77" data-name="Rectangle 77" width="63.229" height="49" fill="#007dc4"></rect>
                        <path id="Path_80" data-name="Path 80" d="M3.7-28.655l6.153,8.046.316.592.316-.592,6.153-8.046H19.52L11.671-18.321,19.52-8.106H16.641l-6.153-8.007-.316-.552-.316.552L3.7-8.106H.825L8.674-18.321.825-28.655Z" transform="translate(21.916 43.053)" fill="#fff"></path>
                    </svg>
                </div>
...
<a id="cartpop" href="#cart_popup" class="popup-wrapper">Вызвать окно с текстом</a>
...
<div class="svg-container">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="29.259" height="30.306" viewBox="0 0 29.259 30.306">
        <g id="searchBtn" transform="translate(0 0)">
            <path id="search-2" data-name="search" d="M29.8,27.6l-7.213-7.5a12.231,12.231,0,1,0-9.365,4.37,12.1,12.1,0,0,0,7.01-2.214L27.5,29.816A1.6,1.6,0,1,0,29.8,27.6ZM13.22,3.192a9.044,9.044,0,1,1-9.044,9.044A9.054,9.054,0,0,1,13.22,3.192Z" transform="translate(-0.984)" fill="#7A7A7A" />
        </g>
    </svg>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="30.534" height="30.533" viewBox="0 0 30.534 30.533">
        <g id="shopping-cart" transform="translate(0.001 0)">
            <g id="shopping-cart-2" data-name="shopping-cart">
                <path id="Path_5" data-name="Path 5" d="M9.16,24.427a3.053,3.053,0,1,0,3.053,3.053A3.062,3.062,0,0,0,9.16,24.427ZM0,0V3.053H3.053l5.5,11.6L6.412,18.32a5.424,5.424,0,0,0-.305,1.527A3.062,3.062,0,0,0,9.16,22.9H27.48V19.847H9.771a.328.328,0,0,1-.305-.305v-.153l1.374-2.6h11.3a2.784,2.784,0,0,0,2.6-1.527l5.5-9.923a.84.84,0,0,0,.305-.763,1.442,1.442,0,0,0-1.527-1.527H6.412L5.038,0ZM24.427,24.427A3.053,3.053,0,1,0,27.48,27.48,3.062,3.062,0,0,0,24.427,24.427Z" fill="#007dc4" />
            </g>
        </g>
    </svg>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="74" height="49" viewBox="0 0 74 49">
        ...
        <g id="search_news_" data-name="поиск (news)" clip-path="url(#clip-path)">
            <g id="Group_310" data-name="Group 310">
                <g id="Group_309" data-name="Group 309">
                    <rect id="Rectangle_49" data-name="Rectangle 49" width="74" height="49" fill="#d95050" />
                </g>
            </g>
            <g id="Group_311" data-name="Group 311">
                <path id="search" d="M22.541,20.652l-5.4-5.612a9.151,9.151,0,1,0-7.007,3.269,9.056,9.056,0,0,0,5.245-1.657l5.437,5.655a1.194,1.194,0,1,0,1.721-1.655ZM10.138,2.388A6.766,6.766,0,1,1,3.372,9.154,6.774,6.774,0,0,1,10.138,2.388Z" transform="translate(25.814 13.185)" fill="#fff" />
            </g>
        </g>
    </svg>
</div>
