    ...
    <main>
        <section class="pt-0">
            <div class="container-fluid">
                <div class="row">
                    <div class="header-banner open-news-banner" style="background-image: url(<?php if ($images) echo $images[0]['original']; ?>);">
                        <div class="mainBaner-container"></div>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="content-block-news">
                        <div class="oneNews-heading">
                            <div class="data-block">
                                <a href="/news/" class="back-btn"></a>
                                <a href="" class="p"><?php echo $date; ?></a>
                                <p> &#8212; <?php echo $speed; ?> <?php echo $text_speed; ?></p>
                            </div>
                            <h3 class="colorHeading"><?php echo $heading_title; ?></h3>
                        </div>
