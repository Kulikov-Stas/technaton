    ...
    <div class="popup-block">
        <div class="registration">
            ...
            <div class="popup-content">
                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="registrForm">
                    ...
                    <input id="repeatPassword" type="password" name="repeatPassword" placeholder="Подтвердите пароль*">-->
                    ...
                    <?php } ?>
                    <input id="submitButton" type="submit" value="<?php echo $button_continue; ?>" class="btn btn-primary" />
                </form>
            </div>
        </div>
    </div>
