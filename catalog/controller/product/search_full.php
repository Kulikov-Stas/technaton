<?php
class ControllerProductSearchFull extends Controller {
	public function index() {
		...
		if (isset($this->request->get['search']) || isset($this->request->get['tag'])) {
			...
			$pagination->url = $this->url->link('product/search_full', $url . '&page={page}');
		...
		// news
        $data = array_merge($data, $this->news());

		$this->response->setOutput($this->load->view('product/search_full', $data));
	}
}
